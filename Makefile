...
debug_fix: COQINE_FLAGS:=polymorph readable fix
debug_fix: debug
...
debug_poly: COQINE_FLAGS:=polymorph readable
debug_poly: debug

.PHONY: lift_mathcomp
lift_mathcomp: ENCODING:=lift_predicates/C.dk
lift_mathcomp: COQINE_FLAGS:=lift_priv readable
lift_mathcomp: mathcomp

.PHONY: debug_mathcomp
debug_mathcomp: ENCODING:=predicates/C.dk
debug_mathcomp: COQINE_FLAGS:=universo readable
